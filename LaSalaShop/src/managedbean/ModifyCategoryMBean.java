...
public class ModifyCategoryMBean implements Serializable{
	...
	public void modifyDataCategory() throws Exception
	{	
		Properties props = System.getProperties();
		Context ctx = new InitialContext(props);
		modifyCategory = (CategoryFacadeRemote) ctx.lookup("java:app/EPCSD_Practica.jar/CategoryFacadeBean!ejb.CategoryFacadeRemote");
		modifyCategory.updateCategory(dataCategory.getId(), dataCategory.getName(), dataCategory.getDescription());
	}
}
